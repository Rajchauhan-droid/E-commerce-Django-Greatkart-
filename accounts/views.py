...
#functionality for activating your account
...
#function for resetpassword validation
...
def edit_profile(request):
    try:
        ...
        # Handle the case where UserProfile does not exist for the user
        # You can redirect to a different page or provide a default profile
        # For now, let's create a new UserProfile for the user
...
@login_required(login_url='login')
def order_detail(reqeust, order_id):
    ...
    return render(reqeust, 'accounts/order_detail.html',context)
